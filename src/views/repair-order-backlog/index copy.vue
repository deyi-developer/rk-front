              ...
              <div class="quarteringPadd" v-if="!itemElement.show">
                ...
                >
                  ...
                  <el-descriptions-item
                    ...
                    label="工单名称"
                    >{{ itemElement.eventTitle }}</el-descriptions-item
                  >
                  ...
                  <el-descriptions-item
                    ...
                    ><el-tooltip placement="top">
                      <div slot="content">{{ itemElement.projectName }}</div>
                ...
                >
                  <el-descriptions-item label="责任人" :labelStyle="threeStyle">
                    <el-tag class="borderRad5" size="small">{{
                      itemElement.handlerName
                    }}</el-tag>
                  </el-descriptions-item>
                  <el-descriptions-item
                    label="优先级/状态"
                    :labelStyle="threeStyle"
                  >
                    <el-tag class="borderRad5" size="small">{{
